...
export const removeLoad = quickFix<
    typeof JpipeIssue.LoadCircular | typeof JpipeIssue.LoadUnresolved | typeof JpipeIssue.LoadNoMatch
>({
    id: 'remove-load',
    codes: [JpipeIssue.LoadCircular, JpipeIssue.LoadUnresolved, JpipeIssue.LoadNoMatch],

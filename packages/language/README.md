...
- [src/jpipe.langium](src/jpipe.langium) -  The grammar definition of your language
- [src/jpipe-module.ts](src/jpipe-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/jpipe-validator.ts](src/jpipe-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/jpipe.monarch.ts](src/syntaxes/jpipe.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/jpipe.tmLanguage.json](syntaxes/jpipe.tmLanguage.json) - Textmate based syntax highlighting instructions.
